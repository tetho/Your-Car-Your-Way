...
ALTER TABLE ONLY chat_message
    ADD CONSTRAINT fk97022dcuxcksytm2l2gyay4y FOREIGN KEY (receiver_user_id) REFERENCES app_user(user_id);
...
ALTER TABLE ONLY chat_message
    ADD CONSTRAINT fks9twvp1tl61n24b6jguerlrty FOREIGN KEY (sender_user_id) REFERENCES app_user(user_id);

CREATE INDEX idx_agency_address_id ON agency(address_id);

CREATE INDEX idx_app_user_address_id ON app_user(address_id);

CREATE INDEX idx_chat_message_receiver_user_id ON chat_message(receiver_user_id);

CREATE INDEX idx_chat_message_sender_user_id ON chat_message(sender_user_id);
